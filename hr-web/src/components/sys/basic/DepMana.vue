<template>
  <div style="width: 500px;">
    ...
    >
      ...
      >
        ...
        <span>
          ...
          <el-button type="danger" size="mini" class="depBtn" @click="() => showUpdateDepView(data)">修改名称</el-button>
        </span>
      </span>
    </el-tree>
    ...
    <el-dialog title="修改部门" :visible.sync="updateDialogVisible" width="30%">
      <div>
        <table>
          <tr>
            <td>
          ...
          <tr>
            ...
            <td>
              <el-input v-model="newDep.name" placeholder="请输入部门名称..."></el-input>
            </td>
          </tr>
        </table>
      </div>
...
export default {
  ...
  methods: {
      showUpdateDepView(data){
          ...
          Object.assign(this.newDep,data);
    ...
    initDeps() {
      let pId = -1;
      this.$getRequest("/system/basic/department/" + pId).then((resp) => {
        if (resp.code == "00000") {
